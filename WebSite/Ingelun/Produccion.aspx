<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Produccion.aspx.cs" Inherits="Produccion" %>
        ...
        <div class="col-xs-12">
             <asp:Panel runat="server" ID="panelCompra" CssClass="panel panel-default" Visible="true">
                   <div class="panel-body container">
                        <div>
                              <h1 class="page-header">Declarar Producción</h1>
                        </div>
                    ...
                    <%--   <div class='col-sm-3 col-md-3 col-lg-3'>
                       ...
                       <asp:GridView ID="gwProductos" runat="server" CssClass="table table-hover" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataKeyNames="id_Producto" GridLines="None" Height="136px" Width="1000px" AutoGenerateColumns="False" OnSelectedIndexChanged="gwProductos_SelectedIndexChanged">
                       ...
                       <div class="row">
                              ...
                              <div class='col-sm-3 col-md-3 col-lg-3'>
                                <div class="form-group">
                                    <asp:Label runat="server" ID="lblCosto" CssClass="labelInput" Text="Precio"></asp:Label>
                       ...
                       <div class="row">
                         ...
                         <div>
                              <h2 class="page-header">Detalle Produccion</h2>
                        </div>

                      <%-- <div class="row">--%>
                            <asp:GridView ID="gwDetalleProduccion" runat="server" Visible="true" CssClass="table table-hover" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" Height="136px" Width="1000px" AutoGenerateColumns="False">
                                <SelectedRowStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />
                                <Columns>
                      ...
                      <div class="row">
                            <div class='col-sm-3 col-md-3 col-lg-3'>
                                <div class="form-group">
                                    ...
                                    <asp:Label runat="server" ID="lblTotalProduccion" CssClass="labelInput" Text=""  Font-Bold="True" Font-Size="Large"></asp:Label>
                                </div>
                              </div>
                      </div>
                       <div class="row">
                            <div class='col-sm-6 col-md-6 col-lg-6'>
                                <asp:Button ID="btnConfirmarProduccion" runat="server" Text="Confirmar Produccion" class="btn btn-primary btn-md" OnClick="btnConfirmarProduccion_Click" />
                                <asp:Label ID="lblMensajeConfirmarProduccion" runat="server" Text="Label" Font-Bold="True" ForeColor="Red" Visible="False"></asp:Label>
                            </div>
                       </div>
